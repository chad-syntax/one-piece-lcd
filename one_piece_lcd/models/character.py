...
class CharacterModel(BaseModel):
    ...
    image_embedding_paths: List[str] = Field(default_factory=list, description="Local paths to full image embeddings (.npy)")
    face_image_paths: List[str] = Field(default_factory=list, description="Local paths to cropped face images")
    face_embedding_paths: List[str] = Field(default_factory=list, description="Local paths to face image embeddings (.npy)")
